...
class UpdateAddressRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'postal_code' => [
                ...
                'string',
                'regex:/^\d{5}$/',
                Rule::exists('villages', 'postal_code')
                    ->where(
                        fn($query) => $query->where(
                            'code',
                            $this->village_code
    ...
    public function messages(): array
    {
        return [
            ...
            'regency_code.exists' =>
            'Kabupaten/Kota yang dipilih tidak sesuai dengan provinsi.',

            'district_code.required' =>
            'Kecamatan wajib dipilih.',

            'district_code.exists' =>
            'Kecamatan yang dipilih tidak sesuai dengan Kabupaten/Kota.',

            'village_code.required' =>
            'Desa/Kelurahan wajib dipilih.',

            'village_code.exists' =>
            'Desa/Kelurahan yang dipilih tidak sesuai dengan Kecamatan.',
            ...
            'postal_code.exists' =>
            'Kode pos tidak sesuai dengan Desa/Kelurahan yang dipilih.',
